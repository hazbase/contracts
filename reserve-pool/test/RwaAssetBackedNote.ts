...
describe('ReservePool asset-backed note coverage', function () {
  it('emits asset-backed note ledger for ABN-CS-03 reserve top-up and compensation workflow', async function () {
    ...
    emitAssetLedger({
      ...
      checks: {
        reserve_top_up_complete: true,
        compensation_paid: 250,
      },
    });
  });
});
